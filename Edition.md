NFT drop utilizing the gas-optimized [ERC721A](https://www.azuki.com/erc721a) which allows minting multiple NFTs for nearly the cost of one.  This contract includes several methods including an option to create Soulbound NFTs, conduct allowlisted releases, create token gates, and more.
